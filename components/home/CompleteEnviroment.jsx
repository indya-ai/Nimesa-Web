...
function CompleteEnviroment() {
  return (
    <div>
      ...
      <p className="text-gray md:w-[50%] text-center mx-auto">
        NIMESA vision is to enable availability of critical data to various
        stakeholders with unmatchable efficiency and SLAs.
      </p>
      <div className="container grid items-center md:py-8 py-2 md:grid-cols-2 gap-[8px] px-2 m-auto">
        <div className="xl:pr[60px] lg:pr-[25px] md:pr-[16px]">
          ...
          <p className="text-lg md:text-left text-center text-gray">
            ...
            using user defined SLA policies and schedulers. Safeguard your data
            and applications effortlessly with our Automated Protection
            features.
          </p>
        </div>
      ...
      <div className="container grid items-center md:py-8 py-2 md:grid-cols-2 gap-[8px] px-2 m-auto">
        ...
        <div className="xl:px-[60px] lg:px-[25px] md:px-[16px]">
          ...
          <p className="text-lg md:text-left text-center text-gray">
            ...
            cloud native technologies like EBS Snapshots. Protect your valuable
            data with our Efficient Backup solution, designed for speed,
