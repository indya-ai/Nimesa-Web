  ...
  return (
    <div>
      <h3 className="xl:text-[56px] text-center md:text-[40px] text-[32px] playfair-font text-[#212121]">
        Boosting efficiency to rapid innovation
      </h3>
      ...
      <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-4 md:mt-8">
        <div className="text-center flex flex-col gap-3">
          ...
          <p>
            Easily scale your resources up or down based on your business needs,
        ...
        <div className="text-center flex flex-col gap-3">
          ...
          <p>
            ...
            integrate with your on-premise infrastructure.
          </p>
        </div>
        <div className="text-center flex flex-col gap-3">
          ...
          <p>
            ...
            platform helps you optimize costs.
          </p>
        </div>
      </div>
    </div>
